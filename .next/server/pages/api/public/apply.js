"use strict";(()=>{var a={};a.id=8609,a.ids=[8609],a.modules={2922:(a,b,c)=>{c.d(b,{XG:()=>g,hG:()=>i,it:()=>h});var d=c(88251);let e=["leave","claim","overtime","expenses","payroll","kpi","partners","procurement","business_dev","applicants","asset_loan"],f={email_profile:"hr",notify_employee:"1",notify_approver:"1",notify_every_level:"0",cc_email:"",rest_days:"0,6",holiday_state:"",email_subject_approved:"",email_body_approved:"",email_subject_rejected:"",email_body_rejected:""};function g(a){return"string"==typeof a&&e.includes(a)}async function h(a){let b={...f};try{for(let c of(await (0,d.P)("SELECT setting_key, value FROM hr_module_settings WHERE module = ?",[a])))c.setting_key in b&&(b[c.setting_key]=c.value??"")}catch{}return b}async function i(a,b,c){let e=[];for(let g of Object.keys(f)){if(!(g in b))continue;let f=b[g],h=null==f?"":String(f);await (0,d.P)(`INSERT INTO hr_module_settings (module, setting_key, value, updated_by)
      ...
      ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'pending', NOW())`,[k("career_posting_id"),p,k("full_name"),k("ic_number"),k("gender"),k("date_of_birth"),k("nationality")||"Malaysian",k("religion"),k("marital_status")||"Single",k("email"),k("phone_number"),k("alt_phone_number"),k("ic_address"),k("ic_postcode"),k("ic_city"),k("ic_state"),k("ic_country")||"Malaysia","true"===k("same_as_ic_address")?k("ic_address"):k("current_address"),"true"===k("same_as_ic_address")?k("ic_postcode"):k("current_postcode"),"true"===k("same_as_ic_address")?k("ic_city"):k("current_city"),"true"===k("same_as_ic_address")?k("ic_state"):k("current_state"),"true"===k("same_as_ic_address")?k("ic_country")||"Malaysia":k("current_country"),"true"===k("same_as_ic_address"),k("emergency_name"),k("emergency_relationship"),k("emergency_phone"),k("emergency_email"),k("emergency_address"),k("highest_education"),k("field_of_study"),parseInt(k("years_of_experience"))||0,k("current_employer"),k("current_position"),parseFloat(k("expected_salary"))||null,k("notice_period"),k("available_start_date")||null,r,s,t,k("cover_message"),k("how_did_you_hear")]);let u=await (0,e.P)("SELECT title FROM career_postings WHERE id = ?",[k("career_posting_id")]),v=u.length>0?u[0].title:"Position";try{await (0,f.Dw)({application_no:p,full_name:k("full_name"),email:k("email"),phone_number:k("phone_number"),position:v,years_of_experience:parseInt(k("years_of_experience"))||0}),await (0,f.BR)({full_name:k("full_name"),email:k("email"),application_no:p,position:v})}catch(a){console.error("Email notification error:",a)}b.status(201).json({success:!0,message:"Application submitted successfully!",application_no:p})}catch(a){console.error("Application submission error:",a),b.status(500).json({error:"Failed to submit application"})}}}d()}catch(a){d(a)}})},75600:a=>{a.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},91823:(a,b,c)=>{c.d(b,{BR:()=>k,Dw:()=>g,Hi:()=>j,Mn:()=>h,jo:()=>i});var d=c(2066),e=c(2922);let f={async sendMail(a){let b=await (0,e.it)("applicants"),c=b.email_profile||"hr",f=await (0,d.OT)(c,{to:a.to,subject:a.subject,html:a.html,cc:a.cc||b.cc_email||void 0});if(!f.success)throw Error(f.error||`the "${c}" email profile could not send`);return f}};async function g(a){let b={from:"hr@ansartechnologies.my",to:"hr@ansartechnologies.my",subject:`New Job Application - ${a.application_no}`,html:`
    ...
    `};try{return await f.sendMail(b),{success:!0}}catch(a){return console.error("Error sending application confirmation:",a),{success:!1,error:a}}}}};var b=require("../../../webpack-api-runtime.js");b.C(a);var c=b.X(0,[7169,2816],()=>b(b.s=30704));module.exports=c})();